...
## Introduction:
1. The video shows a case study of containerization in DevOps. The concept of Docker containerization is msassively used in the Cloud world. Watch The following video to understand the [Docker](https://youtu.be/rOTqprHv1YE) terminologies. 
